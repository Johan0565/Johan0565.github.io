export const translations = {
  ru: {
    ...
    activity: {
      ...
      courseraProgressTitle: 'Google Project Management',
      courseraProgressSubtitle: 'Professional Certificate · Coursera',
      courseraProgressCompleted: 'Пройден',
      courseraProgressLocked: 'Ещё не пройден',
      courseraProgressOf: 'из',
      courseraProgressCourses: 'курсов пройдено',
      courseraViewCert: 'Открыть сертификат ↗',
      courseraCourse1: 'Foundations of Project Management',
      courseraCourse2: 'Project Initiation: Starting a Successful Project',
      courseraCourse3: 'Project Planning: Putting It All Together',
      courseraCourse4: 'Project Execution: Running the Project',
      courseraCourse5: 'Agile Project Management',
      courseraCourse6: 'Applying Project Management in the Real World',
      courseraCourse7: 'Google Project Management: Capstone',
  ...
  en: {
    ...
    activity: {
      ...
      courseraProgressTitle: 'Google Project Management',
      courseraProgressSubtitle: 'Professional Certificate · Coursera',
      courseraProgressCompleted: 'Completed',
      courseraProgressLocked: 'Not yet completed',
      courseraProgressOf: 'of',
      courseraProgressCourses: 'courses completed',
      courseraViewCert: 'Open certificate ↗',
      courseraCourse1: 'Foundations of Project Management',
      courseraCourse2: 'Project Initiation: Starting a Successful Project',
      courseraCourse3: 'Project Planning: Putting It All Together',
      courseraCourse4: 'Project Execution: Running the Project',
