export const translations = {
  ru: {
    ...
    activity: {
      ...
      quoteBtn: 'Цитата',
      quoteDesc: 'Посмотреть короткое видео',
      quoteModalTitle: 'Цитата',
      ...
      duolingoTitle: 'Duolingo Activity',
      duolingoDesc: 'Мой прогресс в изучении английского языка с русского.',
      duolingoChartTitle: 'Опыт по курсам',
      duolingoXpLevel: 'Уровень английского',
      duolingoCourseXp: 'Опыт курса',
      duolingoStreak: 'Дней подряд',
      duolingoLoading: 'Загрузка данных Duolingo...',
      duolingoError: 'Не удалось загрузить данные Duolingo.',
      lastUpdated: 'Обновлено',
      radarTitle: 'Активность по дням недели',
      radarDesc: 'Распределение коммитов по дням недели за выбранный год.',
  ...
  en: {
    ...
    activity: {
      ...
      quoteBtn: 'Quote',
      quoteDesc: 'Watch a short video',
      quoteModalTitle: 'Quote',
      ...
      duolingoTitle: 'Duolingo Activity',
      duolingoDesc: 'My progress learning English from Russian.',
      duolingoChartTitle: 'XP by course',
      duolingoXpLevel: 'English level',
      duolingoCourseXp: 'Course XP',
      duolingoStreak: 'Day streak',
      duolingoLoading: 'Loading Duolingo data...',
      duolingoError: 'Failed to load Duolingo data.',
      lastUpdated: 'Updated',
      radarTitle: 'Activity by day of week',
      radarDesc: 'Commit distribution by day of week for the selected year.',
